...
class NominaItemTest {
  ...
  void getDeduccionSalarial() {
    assertEquals(
        732.83,
        nominaItem.getDeduccionSalarial().getDeduccionIsss().getSalarioLiquido().getDecimal());
    assertEquals(
        700.73,
        nominaItem.getDeduccionSalarial().getDeduccionAfp().getSalarioLiquido().getDecimal());
    assertEquals(
        639.78,
